  //basic cookie challenge
    ...
    let ebv = localStorage.getItem('ebv');
  
    if(gcb("ebv_") != ""){
      if(ebv == null){
        document.cookie = "ebv="+BalooFingerprint()+"; SameSite=None; path=/; Secure";
      } else {
        localStorage.removeItem('ebv');
        document.cookie = 'ebv_=; Max-Age=-99999999; SameSite=None; Secure';
      }
    ...
    function redirect(){
      if(pass == true && dpass == true){
        if(sapr == true){
          ...
          document.cookie = "__pftbn_=nhmj-nknb-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
          tmfgdl = true;
          bscctty();
          window.location.reload();
        }
    ...
    function ifsfb(){
      ...
      iframe.srcdoc = `<!DOCTYPE html><p>bxv runs all</p>`;
    ...
    if(isMobile()){
      document.cookie = "tdim="+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    }
    
    function BalooFingerprint() {
    ...
    */
    ...
    if((window.screen.width < window. screen.availWidth || window.screen.height < window.screen.availHeight) && screen.orientation != undefined){
      document.cookie = "lass=grfe-gtfu-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
      tmfgdl = true;
    }
  
    //experimental #8
    if(navigator.languages == "") {
      document.cookie = "abem=zuhs-hzun-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
      tmfgdl = true;
    }
    ...
    function ngot(){
      navigator.plugins.refresh = 'baloo';
      const overrideTest = navigator.plugins.refresh === 'baloo';
      return overrideTest;
    }
    ...
    function chcim(){
      ...
      chcimage.src = "http://bxvrunsall.jg";
      chcimage.setAttribute("id", "bxvmitigation");
    ...
    function fgtst(){
      ...
      document.cookie = "ftsn="+nameMatch+"-zujn-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
      document.cookie = "fgtsr="+refMatch+"-fdxy-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    }
    ...
    if(cjco()){
      document.cookie = "cjco=hmnb-zujn-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    }
  
    if(cjct()){
      document.cookie = "cjct=hmnb-zujn-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    }
  
    if(cjch()){
      document.cookie = "cjch=hmnb-zujn-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    }
  
    //experimental #9
    if(tcrt() && (navigator.userAgent.includes("Linux")) && !isMobile()){
      document.cookie = "tcrt=hmnb-zujn-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
      tmfgdl = true;
    }
  
    //experimental #10
    if(tmdns()){
      document.cookie = "tmdns=dniym-san-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    }
  
    //experimental #11
    if(tppt()){
      document.cookie = "tppt=uhjn-jul-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    }
  
    //experimental #12
    if(mbcb()){
      document.cookie = "mbcb=zhuj-gzb-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
      tmfgdl = true;
    }
  
    //experimental #13
    iwbyn();
    document.cookie = "iwbyn="+iwbyndepth+"-"+iwbynerrorStacklength+"-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    
    //experimental #14
    if(!ngot()){
      document.cookie = "ngot=nhmj-nknb-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
      tmfgdl = true;
    }
  
    //experimental #16
    if(chcim()){
      document.cookie = "chcim=zgnj-gvhb-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    }
  
    //experimental #17
    if(jbmb()){
      document.cookie = "jbmb=zgnj-gvhb-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
      tmfgdl = true;
    }
  
    //experimental #18
    if(jbmc()){
      document.cookie = "jbmc=nhmj-gvhb-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
      tmfgdl = true;
    }
  
    //experimental #19
    if(jbmm()){
      document.cookie = "jbmm=gvhb-gvhb-"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
      tmfgdl = true;
    }
  
    //experimental #22
    if(ifsfb()){
      document.cookie = "ifsfb=nhmj-nknb"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
      tmfgdl = true;
    }
  
    //experimental #23
    if(fsbel()){
      document.cookie = "fsbel=nhmj-nknb"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
      tmfgdl = true;
    }
  
    //experimental #24
    if(epnd()){
      document.cookie = "epnd=nhmj-nknb"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    }
  
    //experimental #25
    if(rcem()){
      document.cookie = "rcem=nhmj-nknb"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    }
  
    //experimental #26
    if(ebnd()){
      document.cookie = "ebnd=nhmj-nknb"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    }
  
    //experimental #27
    if(bhbc()){
      document.cookie = "bhbc=nhmj-nknb"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    }
  
    //experimental #28
    if(location.protocol !== 'https:'){
      document.cookie = "tcins=nhmj-nknb"+BalooFingerprint()+"; SameSite=None; path=/; Secure";
      tmfgdl = true;
    }
    ...
    //experimental #30
    if(iotd()){
      document.cookie = "iotd="+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    }
  
    //experimental #31
    if(iofd()){
      document.cookie = "iofd="+BalooFingerprint()+"; SameSite=None; path=/; Secure";
    }
  
    if(ebv == null){
      localStorage.setItem('ebv', BalooFingerprint());
    }
    ...
    document.cookie = "bos="+bozo+"-"+ghj+"-"+BalooFingerprint()+"-"+ocs+"-ki89; SameSite=None; path=/; Secure";
